...
\hline
	...
	All positive &$^{5}C_{5}(0.9)^{0}(0.1)^{5}$ &0.00001\\ \hline
	4 positive 1 negative &$^{5}C_{4}(0.9)^{1}(0.1)^{4}$ &0.00045  \\ 
	\hline
	3 positive 2 negative &$^{5}C_{3}(0.9)^{2}(0.1)^{3}$ &0.00810 \\ 
	\hline
	2 positive 3 negative &$^{5}C_{2}(0.9)^{3}(0.1)^{2}$ &0.07290\\ \hline
	1 positive 4 negative &$^{5}C_{1}(0.9)^{4}(0.1)^{1}$ &0.32805 \\ \hline
	All negaive &$^{5}C_{0}(0.9)^{5}(0.1)^{0}$ &0.5904 \\ \hline
\end{tabular}
\end{table}
\begin{align}
\end{align}
...
Expected number of tests for one set(a)
\begin{align}
a &= 1 + 5*F_{X}(4)  \\
&= 1 + 5*0.4096 \\
&= 3.048
\end{align}
Total expected number of sets(T)
\begin{align}
T &= 200 * (a) \\
&= 200 * 3.048 \\
&= 609.6
